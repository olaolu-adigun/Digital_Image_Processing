...
public:
	...
	// Performs thinning on the image and returns the thinned image.
	unsigned char*** Thinning();

	// Performs skeletonizing of the image and returns the output.
	unsigned char*** Skeletonizing();
...
private:
	...
	// This method handles the conditional mask pattern of thinning
	//    for a given pixel in an image array.
	// returns the marked value for the pixels
	bool mask_pattern_thin_conditional(bool*** arr, int i, int j);

	// This method handles the conditional mask pattern of skeletonizing
	//    for a given pixel in an image array.
	// returns the marked value for the pixels
	bool mask_pattern_skeleton_conditional(bool*** arr, int i, int j);
	...
	// This method handles the unconditional mask pattern for skeletonizing
	//    a given pixel in an image array.
	// returns the marked value for the pixels
	bool mask_pattern_skeletonize_unconditional(bool*** arr, int i, int j);
